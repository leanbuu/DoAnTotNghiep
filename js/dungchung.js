...
function themVaoGioHang(masp, tensp) {
    ...
    if (user.off) {
        alert('Tài khoản của bạn đã bị khóa và không thể mua hang!');
	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a href="https://www.facebook.com/AnQuocnT" class="fa fa-facebook"></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ cửa hàng A&H" title="Trang chủ cửa hàng A&H">
            </a>
        </div> <!-- hết phần logo -->
        ...
        <div class="content">
            ...
            </div> <!-- hết phần tìm kiếm ở header -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Cửa Hàng Điện Thoại A&H</a> - All rights reserved © 2022 - Designed by
            <span  style="color: #eee; font-weight: bold"><a href="https://www.facebook.com/AnQuocnT">QUỐC AN</a></span></p>
    </div>`);
}
